...
export const privacyEn: LegalDocument = {
  ...
  intro: [
    'Perfect Blue is an online property portal where users can browse property listings, create an account, publish listings, upload listing photos, and send messages to advertisers through the platform.',
    'This Privacy Policy explains how Perfect Blue ("we", "us" or "our") processes personal data when you use our website, create an account, publish a listing, upload photos, contact us, or communicate with other users through the platform. It is a practical explanation of our current service and may be updated as the service changes.',
  ],
  sections: [
    {
    ...
    {
      heading: 'Legal bases',
      paragraphs: ['We normally rely on the following legal bases under the GDPR:'],
      listItems: [
    ...
    {
      heading: 'Messages and user-generated content',
      paragraphs: [
